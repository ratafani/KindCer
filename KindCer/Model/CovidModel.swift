...
class CovidModel : NSObject,ObservableObject{
    ...
    func getData(){
        ...
        let dMax = mDeaths.max()
        let rMax = mRecovered.max()
        //        print(cMax)
        ...
        //
        //        var mDeaths : [Double] = [Double(self.timeSeries?.Indonesia.last?.deaths ?? 0),
        //        Double(self.timeSeries?.US.last?.deaths ?? 0),
        //        Double(self.timeSeries?.Singapore.last?.deaths ?? 0),
        //        Double(self.timeSeries?.Japan.last?.deaths ?? 0),
        //        Double(self.timeSeries?.China.last?.deaths ?? 0),]
        //
        //        let dMax = mDeaths.max()
        ////        print(dMax)
        //        for i in 0..<mDeaths.count{
        //            mDeaths[i] = (mDeaths[i]/(cMax ?? 1) * 100)
        //        }
        //
        //        var mRecovered : [Double] = [Double(self.timeSeries?.Indonesia.last?.recovered ?? 0),
        //        Double(self.timeSeries?.US.last?.recovered ?? 0),
        //        Double(self.timeSeries?.Singapore.last?.recovered ?? 0),
        //        Double(self.timeSeries?.Japan.last?.recovered ?? 0),
        //        Double(self.timeSeries?.China.last?.recovered ?? 0),]
        //
        //        let rMax = mRecovered.max()
        ////        print(rMax)
        //        for i in 0..<mRecovered.count{
        //            mRecovered[i] = (mRecovered[i]/(cMax ?? 1) * 100)
        //        }
